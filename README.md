...
Upload a trained ML model (.pkl or .joblib)

Upload the dataset used to train it (.csv)

Select the target column

(Optional) Select a sensitive attribute for bias analysis

GlassBox analyzes the model and shows explanations
